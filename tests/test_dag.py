...
class TestDagIntegrity(unittest.TestCase):
    def setUp(self):
        self.dagbag = DagBag(dag_folder="/Users/vivekchaganti/projects/user_analytics_pipeline/dags", include_examples=False)
    ...
    def test_task_ids(self):
        ...
        dag = self.dagbag.get_dag("user_analytics_etl_pipeline")
        expected_tasks = {"extract_api_to_parquet", "load_parquet_to_staging", "transform_staging_to_warehouse", "cleanup_old_parquet_files"}
